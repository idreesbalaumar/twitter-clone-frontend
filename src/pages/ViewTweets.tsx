...
import { fetchTweets } from "../features/tweets/tweetsSlice";
import logo from "../assets/images/x-by-bt.png";

const ViewTweets: React.FC = () => {
  ...
  return (
    <div className="flex roboto-font">
      <div className="w-2/5 text-white h-12 pl-32 py-4 h-auto">
        ...
        <nav className="mt-5 px-2">
          <a
            href="#"
            className="group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full bg-zinc-900 text-white"
          >
            <svg
          ...
          <a
            href="#"
            className="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-semibold rounded-full hover:bg-zinc-900"
          >
            <svg
              className="mx-2 h-6 w-6"
              fill="none"
          ...
          <a
            href="#"
            className="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-zinc-900"
          >
            <svg
              className="mx-2 h-6 w-6"
              fill="none"
          ...
          <button className="bg-blue-400 w-48 mt-5 hover:bg-blue-500 text-white font-bold py-2 px-4 rounded-full">
            Post
          </button>
        </nav>
          ...
          <div className="w-10">
            <div className="w-64 px-2">
              <div className="flex items-center">
                ...
                <div className="flex-1 text-center py-2 m-2">
                  <button className="bg-blue-400 hover:bg-blue-500 text-white font-bold py-2 px-8 rounded-full mr-8 float-right">
                    Post
                  </button>
                </div>
              </div>
            ...
            {/* <div className="flex-1">
              <button className="bg-blue-400 mt-5 hover:bg-blue-500 text-white font-bold py-2 px-8 rounded-full mr-8 float-right">
                Post
              </button>
            </div> */}
          </div>
        </div>
        <hr className="border-zinc-700 border-4" />
        {/* <!--first tweet start--> */}
      ...
      <div className="w-2/5 h-12">
        <div className="relative text-gray-300 w-80 p-5 pb-0 mr-16">
          ...
          <input
            ...
            name="search"
            placeholder="Search"
            className="bg-zinc-800 h-10 px-10 pr-5 w-full rounded-full text-sm focus:outline-none shadow rounded border-0"
          />
        </div>

        {/* <!--second-trending tweet section--> */}
        <div className="max-w-sm rounded-lg border border-zinc-700 overflow-hidden shadow-lg m-4 mr-20">
          <div className="flex">
            <div className="flex-1 m-2">
    ...
    //     {tweetState.loading && <p className="text-blue-500">Loading...</p>}
    //     {tweetState.error && <p className="text-red-500">Error: {tweetState.error}</p>}
    //     {tweetState.tweets.map((tweet: any) => (
    //       <div key={tweet.id} className="p-4 mb-2 border border-gray-300 rounded">
    //         <p>{tweet.content}</p>
    //       </div>
    //     ))}
    //   </div>
